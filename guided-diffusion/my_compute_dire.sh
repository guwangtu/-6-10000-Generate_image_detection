...
SAVE_FLAGS="--images_dir /data_nas/users/shx/datasets/Artifact --recons_dir /data_nas/users/shx/datasets/Artifact_recons --dire_dir /data_nas/users/shx/datasets/Artifact_dire"
